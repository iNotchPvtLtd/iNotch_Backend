import {
  ...
  STATES,
  VerticalDivider
} from "./chunk-YZIBEWXK.js";
import {
  RelativeTime
} from "./chunk-7KR23KFC.js";
import {
  useEnterprise
...
// node_modules/@strapi/admin/dist/admin/admin/src/pages/Home/components/ContentManagerWidgets.mjs
...
// node_modules/@strapi/admin/dist/admin/admin/src/pages/Home/components/Widget.mjs
var import_jsx_runtime = __toESM(require_jsx_runtime(), 1);
var React = __toESM(require_react(), 1);
var Root = ({ title, icon = ForwardRef$19, children }) => {
...
var DocumentStatus = ({ status = "draft" }) => {
  ...
  const { formatMessage } = useIntl();
  return (0, import_jsx_runtime2.jsx)(Status, {
...
var RecentDocumentsTable = ({ documents }) => {
  ...
  return (0, import_jsx_runtime2.jsx)(Table, {
    colCount: 5,
    rowCount: (documents == null ? void 0 : documents.length) ?? 0,
    children: (0, import_jsx_runtime2.jsx)(Tbody, {
      children: documents == null ? void 0 : documents.map((document) => (0, import_jsx_runtime2.jsxs)(Tr, {
        onClick: handleRowClick(document),
        cursor: "pointer",
        children: [
          (0, import_jsx_runtime2.jsx)(Td, {
            children: (0, import_jsx_runtime2.jsx)(CellTypography, {
          ...
          (0, import_jsx_runtime2.jsx)(Td, {
            children: (0, import_jsx_runtime2.jsx)(Box, {
              ...
              children: document.status ? (0, import_jsx_runtime2.jsx)(DocumentStatus, {
...
var LastEditedWidgetContent = () => {
  ...
  if (isLoading) {
    return (0, import_jsx_runtime2.jsx)(Widget.Loading, {});
  }
  if (error || !data) {
    return (0, import_jsx_runtime2.jsx)(Widget.Error, {});
  }
  if (data.length === 0) {
    return (0, import_jsx_runtime2.jsx)(Widget.NoData, {
      children: formatMessage({
  ...
  return (0, import_jsx_runtime2.jsx)(RecentDocumentsTable, {
    documents: data
  });
};
var LastEditedWidget = () => {
  return (0, import_jsx_runtime2.jsx)(Widget.Root, {
    title: {
      id: "content-manager.widget.last-edited.title",
      defaultMessage: "Last edited entries"
    },
    icon: ForwardRef$1v,
    children: (0, import_jsx_runtime2.jsx)(LastEditedWidgetContent, {})
  });
};
...
var LastPublishedWidget = () => {
  return (0, import_jsx_runtime2.jsx)(Widget.Root, {
    ...
    icon: ForwardRef$4D,
    children: (0, import_jsx_runtime2.jsx)(LastPublishedWidgetContent, {})
  });
};
...
var GuidedTourHomepage = () => {
  ...
  const sections = Object.entries(LAYOUT_DATA).map(([key, val]) => ({
    ...
    content: (0, import_jsx_runtime3.jsx)(LinkButton, {
      onClick: () => trackUsage(val.home.trackingEvent),
      tag: NavLink,
      to: val.home.cta.target,
      endIcon: (0, import_jsx_runtime3.jsx)(ForwardRef$5d, {}),
                  ...
                  (0, import_jsx_runtime3.jsxs)(Flex, {
                    children: [
                      (0, import_jsx_runtime3.jsx)(Box, {
                        minWidth: `3rem`,
                        marginRight: 5,
                        children: (0, import_jsx_runtime3.jsx)(Number, {
                          state,
                          children: index + 1
                        })
                      }),
                  ...
                  (0, import_jsx_runtime3.jsxs)(Flex, {
                    ...
                    children: [
                      (0, import_jsx_runtime3.jsx)(Flex, {
                        ...
                        marginTop: 3,
                        marginRight: 5,
                        children: index === sections.length - 1 ? null : (0, import_jsx_runtime3.jsx)(VerticalDivider, {
                          state
                        })
                      }),
                      (0, import_jsx_runtime3.jsx)(Box, {
...
var GuidedTour = () => {
  ...
  return (0, import_jsx_runtime4.jsx)(GuidedTourHomepage, {});
};
    ...
    children: [
      ...
      (0, import_jsx_runtime5.jsx)(Layouts.Content, {
        children: (0, import_jsx_runtime5.jsxs)(Flex, {
          ...
          paddingBottom: 10,
          children: [
            (0, import_jsx_runtime5.jsx)(GuidedTour, {}),
            (0, import_jsx_runtime5.jsxs)(Grid.Root, {
              gap: 5,
              children: [
                (0, import_jsx_runtime5.jsx)(Grid.Item, {
                  col: 6,
                  s: 12,
                  children: (0, import_jsx_runtime5.jsx)(LastEditedWidget, {})
                }),
                (0, import_jsx_runtime5.jsx)(Grid.Item, {
                  col: 6,
                  s: 12,
                  children: (0, import_jsx_runtime5.jsx)(LastPublishedWidget, {})
                })
              ]
            })
          ]
...
var HomePage = () => {
  const Page2 = useEnterprise(
    ...
    async () => (await import("./HomePage-7UFA7PQ3.js")).HomePageEE
  );
  if (!Page2) {
    return null;
  }
  return (0, import_jsx_runtime5.jsx)(Page2, {});
};
...
//# sourceMappingURL=chunk-XBWUP446.js.map
