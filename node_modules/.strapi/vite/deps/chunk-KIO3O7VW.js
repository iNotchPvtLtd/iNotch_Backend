...
} from "./chunk-HNTOL6SN.js";
import {
  QueryClient,
  QueryClientProvider,
  img
} from "./chunk-UH4QNJ4X.js";
import {
...
import {
  require_pick
} from "./chunk-TJKFS7R4.js";
import {
  useEnterprise
} from "./chunk-Z4DPJN53.js";
import {
  GuidedTourProvider,
  useGuidedTour
} from "./chunk-K43KTO4F.js";
import {
  Login
} from "./chunk-KPN6J6DZ.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-6RJEHLOC.js";
import {
  ConfigurationProvider
} from "./chunk-HGS737DJ.js";
import {
  require_baseMerge,
...
import {
  require_baseRest
} from "./chunk-PMUZB5TC.js";
import {
  HistoryProvider
} from "./chunk-ZNA3TV4T.js";
import {
  TrackingProvider,
  useTracking
...
import {
  useClipboard
} from "./chunk-TO7PBCZL.js";
import {
  createAbsoluteUrl,
  useInitQuery
} from "./chunk-7FJPFK3Y.js";
import {
  ADMIN_PERMISSIONS_EE,
  getEERoutes
} from "./chunk-SNBT6OZ4.js";
import {
  errorsTrads
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-AXI7YAUJ.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-CXQYURTZ.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-BTWSHKGH.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-3BNYDDHP.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-Z57LJK4X.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-OYWR4ZNH.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-TNLPNSCB.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-E4QD5AYP.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-BDPTYQC6.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-NOL7EMZB.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-55ZYN3YX.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-F7JQQTQQ.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-ZEPP4S26.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-PEVQAQNL.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-VQVFILRC.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-O3NO3H2Q.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-Y7ULSYRN.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-EPIPTAHA.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-VLYDAB32.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-5FK3LA6J.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-DJXI6MGL.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-BYOR4IFM.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-HLOGSGZW.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-MH7P5SDH.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-WJU7VLUT.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-HLOIEDU2.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-LSFXCKAV.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-5IV4OITW.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-L444KDIO.js");
              return {
...
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    ...
    case "./translations/en.json":
      return import("./en.json-Q255PTV5.js");
...
function __variableDynamicImportRuntime0__(path) {
  switch (path) {
    case "./translations/en-GB.js":
      return import("./en-GB-ZGQNCUHS.js");
    default:
      return new Promise(function(resolve, reject) {
        (typeof queueMicrotask === "function" ? queueMicrotask : setTimeout)(
          reject.bind(null, new Error("Unknown variable dynamic import: " + path))
  ...
  constructor({ config, appPlugins } = {}) {
    ...
    this.addComponents = (components) => {
      if (Array.isArray(components)) {
        components.map((comp) => {
          (0, import_invariant3.default)(comp.Component, "A Component must be provided");
          (0, import_invariant3.default)(comp.name, "A type must be provided");
          this.library.components[comp.name] = comp.Component;
        });
      } else {
        (0, import_invariant3.default)(components.Component, "A Component must be provided");
        (0, import_invariant3.default)(components.name, "A type must be provided");
    ...
    this.addFields = (fields) => {
      if (Array.isArray(fields)) {
        fields.map((field) => {
          (0, import_invariant3.default)(field.Component, "A Component must be provided");
          (0, import_invariant3.default)(field.type, "A type must be provided");
          this.library.fields[field.type] = field.Component;
        });
      } else {
        (0, import_invariant3.default)(fields.Component, "A Component must be provided");
        (0, import_invariant3.default)(fields.type, "A type must be provided");
    ...
    this.addSettingsLinks = (sectionId, links) => {
      (0, import_invariant3.default)(Array.isArray(links), "TypeError expected links to be an array");
    ...
    this.registerHook = (name, fn) => {
      (0, import_invariant3.default)(this.hooksDict[name], `The hook ${name} is not defined. You are trying to register a hook that does not exist in the application.`);
...
//# sourceMappingURL=chunk-KIO3O7VW.js.map
